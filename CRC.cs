...
namespace Crystalfontz.Displays
{
    public class CRC
    {
        ...
        public static void CalculateCRC(ref List<byte> Bytes)
        {
            ...
            {
                work = (work >> 8) ^ crcTable[(work ^ Bytes[_byteCounter]) & 0xff];
                _byteCounter++;
            }

            Bytes.AddRange(BitConverter.GetBytes((ushort)~work));
        }
    }
}
